...
% 
%  robotCoordinate = [0,0,0;-25,-25,0;25,25,0;100,100,pi()/2;75,0,pi();0,-50,0];
%globalMap1 = 200;
%newSize = [0,0];
...
function globalMap3 = globalMap(lStart1,lEnd1,robotCoordinate)
...
if(robotCoordinate(1,1)>=0)   
        ...
        if(globalMapZeroPoint(2)<zeroPoint(2))
...
if(robotCoordinate(1,2)>=0)   
    ...
    if(globalMapZeroPoint(1)<zeroPoint(1))
...
if(robotCoordinate(1,2)>=0)
    gMapStart(1)= globalMapZeroPoint(1)-(globalMapSize(1)-(globalMapSize(1)-globalMapZeroPoint(1)));
else
    gMapStart(1)= bufferSize(1)-globalMapSize(1);
end

if(robotCoordinate(1,1)>=0)
    gMapStart(2)= globalMapZeroPoint(2)-(globalMapSize(2)-(globalMapSize(2)-globalMapZeroPoint(2)));
else
